...
public class SwaggerConfig {
    ...
    private ApiInfo createAI(){
        return new ApiInfoBuilder().title("云商城项目的在线接口文档").//设置标题
                contact(new Contact("Java2004","http://baidu.com","xuwei2088202702@163.com"))
    ...
    public Docket createD(){
        return new Docket(DocumentationType.SWAGGER_2).//指定生成那种类型的文档
                ...
                .select().apis(RequestHandlerSelectors.basePackage("com.iza.login.controller")).//扫描接口所在的包
                        build();
    }
}